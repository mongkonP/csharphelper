...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_histogram_Form1:Form
  { 


        public howto_histogram_Form1()
        {
            InitializeComponent();
        }
        ...
        private void howto_histogram_Form1_Load(object sender, EventArgs e)
        {
