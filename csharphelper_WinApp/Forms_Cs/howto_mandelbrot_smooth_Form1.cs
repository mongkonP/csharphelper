...
namespace csharphelper_WinApp.Forms_Cs
{
    ...
    public partial class howto_mandelbrot_smooth_Form1 : Form
    {
        public howto_mandelbrot_smooth_Form1()
        {
            InitializeComponent();
        }
        ...
        private void howto_mandelbrot_smooth_Form1_Load(object sender, EventArgs e)
        {
            this.Show();
            Application.DoEvents();
            ...
            ResetColors();
            howto_mandelbrot_smooth_MandelbrotConfig frm = new  howto_mandelbrot_smooth_MandelbrotConfig();
            frm.Initialize(this);
...
/// <summary>
    ...
    "eg|GIF|*.gif|PNG|*.png|TIFF|*.tif;*.tiff|All Files|*.*";
            ...
            this.Name = "howto_mandelbrot_smooth_Form1";
            this.Text = "howto_mandelbrot";
            this.Load += new System.EventHandler(this.howto_mandelbrot_smooth_Form1_Load);
