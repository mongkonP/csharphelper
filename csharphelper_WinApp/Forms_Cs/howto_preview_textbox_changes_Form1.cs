...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_preview_textbox_changes_Form1:Form
  { 


        public howto_preview_textbox_changes_Form1()
        {
            InitializeComponent();
        }

        // Attach the TextBox's ContextMenuStrip.
        private void howto_preview_textbox_changes_Form1_Load(object sender, EventArgs e)
        {
        ...
        private void txtInteger_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                cancel_event = ShouldCancelTextBoxEvent(txtInteger, EditType.Cut, ' ', false);
            }
            else if (e.Control && (e.KeyCode == Keys.V))
            {
                cancel_event = ShouldCancelTextBoxEvent(txtInteger, EditType.Paste, ' ', false);
            }
            ...
            {
                cancel_event = ShouldCancelTextBoxEvent(txtInteger, EditType.Delete, ' ', false);
            }
            else if (e.KeyCode == Keys.Back)
            {
                cancel_event = ShouldCancelTextBoxEvent(txtInteger, EditType.Backspace, ' ', false);
            }
            else
            {
        ...
        {
            ShouldCancelTextBoxEvent(txtInteger, EditType.Cut, ' ', true);
        }
        private void ctxPaste_Click(object sender, EventArgs e)
        {
            ShouldCancelTextBoxEvent(txtInteger, EditType.Paste, ' ', true);
        }
        private void ctxDelete_Click(object sender, EventArgs e)
        {
            ShouldCancelTextBoxEvent(txtInteger, EditType.Delete, ' ', true);
        }
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.label2.Text = "Integer Only Here:";
            // 
            // ctxCut
            // 
            ...
            // txtInteger
            // 
            this.txtInteger.Anchor = System.Windows.Forms.AnchorStyles.Top;
            this.txtInteger.Location = new System.Drawing.Point(185, 38);
            ...
            // 
            // howto_preview_textbox_changes_Form1
            // 
            ...
            this.Name = "howto_preview_textbox_changes_Form1";
            this.Text = "howto_preview_textbox_changes";
            this.Load += new System.EventHandler(this.howto_preview_textbox_changes_Form1_Load);
