...
using howto_generic_treenode_weights;
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_generic_treenode_weights_Form1:Form
  { 


        public howto_generic_treenode_weights_Form1()
        {
            InitializeComponent();
        }
        ...
        // Make a tree.
        private void howto_generic_treenode_weights_Form1_Load(object sender, EventArgs e)
        {
            ...
            // Make linkes with random weights.
            Random rand = new Random();
            root.AddChild(a_node, rand.Next(1, 100));
            root.AddChild(b_node, rand.Next(1, 100));
            a_node.AddChild(c_node, rand.Next(1, 100));
            a_node.AddChild(d_node, rand.Next(1, 100));
            b_node.AddChild(e_node, rand.Next(1, 100));
            b_node.AddChild(f_node, rand.Next(1, 100));
            b_node.AddChild(g_node, rand.Next(1, 100));
            e_node.AddChild(h_node, rand.Next(1, 100));
        ...
        {
            howto_generic_treenode_weights_NodeTextDialog dlg = new  howto_generic_treenode_weights_NodeTextDialog();
            if (dlg.ShowDialog() == DialogResult.OK)
            {
                string text = dlg.txtNodeText.Text;
                int weight = int.Parse(dlg.txtLinkWeight.Text);
                TreeNode<CircleNode> child =
                    new TreeNode<CircleNode>(new CircleNode(text));
                SelectedNode.AddChild(child, weight);
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.picTree.Size = new System.Drawing.Size(295, 248);
            ...
            // 
            // howto_generic_treenode_weights_Form1
            // 
            ...
            this.Name = "howto_generic_treenode_weights_Form1";
            this.Text = "howto_generic_treenode_weights";
            this.Load += new System.EventHandler(this.howto_generic_treenode_weights_Form1_Load);
