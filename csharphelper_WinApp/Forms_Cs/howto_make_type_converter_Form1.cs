...
using howto_make_type_converter;
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_make_type_converter_Form1:Form
  { 


        public howto_make_type_converter_Form1()
        {
            InitializeComponent();
        }

        private void howto_make_type_converter_Form1_Load(object sender, EventArgs e)
        {
            // Make some people.
            Person[] people =
            {
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            // 
            // howto_make_type_converter_Form1
            // 
            ...
            this.Name = "howto_make_type_converter_Form1";
            this.Text = "hwoto_make_type_converter";
            this.Load += new System.EventHandler(this.howto_make_type_converter_Form1_Load);
