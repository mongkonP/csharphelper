...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_buttons_over_picture2_Form1:Form
  { 


        public howto_buttons_over_picture2_Form1()
        {
            InitializeComponent();
        }

        private void howto_buttons_over_picture2_Form1_Load(object sender, EventArgs e)
        {
            Button[] buttons = { button1, button2,
                button3, button4, button5, button6 };
            foreach (Button btn in buttons)
                SetButtonBackground(pictureBox1, btn, 128);
        }
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            // 
            // howto_buttons_over_picture2_Form1
            // 
            ...
            this.Name = "howto_buttons_over_picture2_Form1";
            this.Text = "howto_buttons_over_picture2";
            this.Load += new System.EventHandler(this.howto_buttons_over_picture2_Form1_Load);
