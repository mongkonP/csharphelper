...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class langtonsantsimulator_richardmoss_NewSimulationDialog:langtonsantsimulator_richardmoss_BaseForm
  { 
  ...
  #region  Public Constructors  
    ...
    public langtonsantsimulator_richardmoss_NewSimulationDialog()
    {
      InitializeComponent();
    }

    public langtonsantsimulator_richardmoss_NewSimulationDialog(ISimulation simulation)
      : this()
    {
...
/// <summary>
    ...
    private void InitializeComponent()
    {
      ...
      // 
      // langtonsantsimulator_richardmoss_NewSimulationDialog
      // 
      ...
      this.Name = "langtonsantsimulator_richardmoss_NewSimulationDialog";
