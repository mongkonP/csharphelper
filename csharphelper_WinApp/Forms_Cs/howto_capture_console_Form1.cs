...
using howto_capture_console;
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_capture_console_Form1:Form
  { 


        public howto_capture_console_Form1()
        {
            InitializeComponent();
        }

        // Install a new output TextWriter for the Console window.
        private void howto_capture_console_Form1_Load(object sender, EventArgs e)
        {
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "howto_capture_console_Form1";
            this.Text = "howto_capture_console";
            this.Load += new System.EventHandler(this.howto_capture_console_Form1_Load);
