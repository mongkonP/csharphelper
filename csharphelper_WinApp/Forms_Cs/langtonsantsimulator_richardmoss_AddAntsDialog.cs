...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class langtonsantsimulator_richardmoss_AddAntsDialog:langtonsantsimulator_richardmoss_BaseForm
  { 
  ...
  #region  Public Constructors  
    ...
    public langtonsantsimulator_richardmoss_AddAntsDialog()
    {
      InitializeComponent();
    }

    public langtonsantsimulator_richardmoss_AddAntsDialog(ISimulation simulation)
      : this()
    {
...
/// <summary>
    ...
    private void InitializeComponent()
    {
      ...
      // 
      // langtonsantsimulator_richardmoss_AddAntsDialog
      // 
      ...
      this.Name = "langtonsantsimulator_richardmoss_AddAntsDialog";
