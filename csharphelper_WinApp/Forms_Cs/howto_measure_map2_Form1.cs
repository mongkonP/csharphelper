...
using howto_measure_map2;
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_measure_map2_Form1:Form
  { 


        public howto_measure_map2_Form1()
        {
            InitializeComponent();
        }
        ...
        private void Scale_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            // Get the scale.
            howto_measure_map2_ScaleDialog dlg = new  howto_measure_map2_ScaleDialog();
        ...
        // Display the units per pixels and the measured distance.
        private void DisplayValues()
        {
            if (CurrentUnit == Units.Undefined)
            {
                btnScale.Text = "<Click to set scale>";
            }
            else
            {
                double units = ScaleDistanceInUnits / ScaleDistanceInPixels;
                btnScale.Text = string.Format("{0} {1}/pixel",
                    units.ToSignificantDigits(3),
                    CurrentUnit.ToString());
            }

            if (CurrentDistance < 0)
            {
                btnDistance.Text = "<Click to measure a distance>";
            }
            else
            {
                btnDistance.Text = string.Format("Distance: {0} {1}",
                    CurrentDistance.ToSignificantDigits(3), CurrentUnit);
            }
        }
...
/// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(howto_measure_map2_Form1));
            ...
            this.btnScale.Text = "<Click to set scale>";
            ...
            this.btnDistance.Size = new System.Drawing.Size(171, 22);
            this.btnDistance.Text = "<Click to measure a distance>";
            ...
            this.Name = "howto_measure_map2_Form1";
            this.Text = "howto_measure_map2";
