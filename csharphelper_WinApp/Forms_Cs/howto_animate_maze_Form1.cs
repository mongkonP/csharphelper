...
using howto_animate_maze;
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_animate_maze_Form1:Form
  { 


        public howto_animate_maze_Form1()
        {
            InitializeComponent();
        }
        ...
        private void howto_animate_maze_Form1_FormClosing(object sender, FormClosingEventArgs e)
        {
            StopRunning();
        }
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "howto_animate_maze_Form1";
            this.Text = "howto_animate_maze";
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.howto_animate_maze_Form1_FormClosing);
