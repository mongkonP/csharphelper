...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_newtons_method_fractal2_Form1:Form
  { 


        public howto_newtons_method_fractal2_Form1()
        {
            InitializeComponent();
        }
...
#region "Functions"
        ...
        {
            return (x ^ (Complex)Power) - ((Complex)Power ^ x);
        }

        // dFdx(x) = Power * x ^ (Power - 1) - Power ^ x * ln(Power).
        private Complex dFdx(Complex x)
        {
            return Power * (x ^ (Complex)(Power - 1)) -
                ((Complex)Power ^ x) * Math.Log(Power);
        }

#endregion // Functions

        // Draw the initial picture.
        private void howto_newtons_method_fractal2_Form1_Load(object sender, EventArgs e)
        {
            // Display the form.
            this.Show();
        ...
        {
            howto_newtons_method_fractal2_PowerForm dlg = new  howto_newtons_method_fractal2_PowerForm();
            dlg.Power = Power;
            try
            {
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.picCanvas.Size = new System.Drawing.Size(310, 352);
            ...
            // 
            // howto_newtons_method_fractal2_Form1
            // 
            ...
            this.Name = "howto_newtons_method_fractal2_Form1";
            this.Text = "Power: 2";
            this.Load += new System.EventHandler(this.howto_newtons_method_fractal2_Form1_Load);
