...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_decimal_nud_Form1:Form
  { 


        public howto_decimal_nud_Form1()
        {
            InitializeComponent();
        }

        // Redraw on resize.
        private void howto_decimal_nud_Form1_Load(object sender, EventArgs e)
        {
            ResizeRedraw = true;
            nudScale.Minimum = 0;
            nudScale.Maximum = 1;
        ...
        // Draw an ellipse.
        private void howto_decimal_nud_Form1_Paint(object sender, PaintEventArgs e)
        {
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "howto_decimal_nud_Form1";
            this.Text = "howto_decimal_nud";
            this.Load += new System.EventHandler(this.howto_decimal_nud_Form1_Load);
            this.Paint += new System.Windows.Forms.PaintEventHandler(this.howto_decimal_nud_Form1_Paint);
