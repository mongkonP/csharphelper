...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_draw_text_along_curve2_Form1:Form
  { 


        public howto_draw_text_along_curve2_Form1()
        {
            InitializeComponent();
        }

        // Draw some text along a curve.
        private void howto_draw_text_along_curve2_Form1_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void DrawTextOnSegment(Graphics gr, Brush brush, Font font, string txt, ref int first_ch, ref PointF start_point, PointF end_point, bool text_above_segment)
        {
            ...
            while (last_ch < txt.Length)
            {
                ...
                if (MeasureText(gr, test_string, font).Width > dist)
                {
            ...
            if (text_above_segment)
            {
                gr.TranslateTransform(0,
                    -MeasureText(gr, chars_that_fit, font).Height,
                    MatrixOrder.Append);
            }
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            this.SuspendLayout();
            // 
            // howto_draw_text_along_curve2_Form1
            // 
            ...
            this.Name = "howto_draw_text_along_curve2_Form1";
            this.Text = "howto_draw_text_along_curve2";
            this.Paint += new System.Windows.Forms.PaintEventHandler(this.howto_draw_text_along_curve2_Form1_Paint);
