...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_file_replace_Form1:Form
  { 


        public howto_file_replace_Form1()
        {
            InitializeComponent();
        }

        private void howto_file_replace_Form1_Load(object sender, EventArgs e)
        {
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "howto_file_replace_Form1";
            this.Text = "howto_file_replace";
            this.Load += new System.EventHandler(this.howto_file_replace_Form1_Load);
