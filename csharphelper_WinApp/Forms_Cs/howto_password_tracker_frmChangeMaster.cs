...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_password_tracker_frmChangeMaster:Form
  { 


        public howto_password_tracker_frmChangeMaster()
        {
            InitializeComponent();
        }

        private void howto_password_tracker_frmChangeMaster_Load(object sender, EventArgs e)
        {
            SettingStuff.RestoreFormPosition(this, "MasterForm");
        }

        private void howto_password_tracker_frmChangeMaster_FormClosing(object sender, FormClosingEventArgs e)
        {
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            // 
            // howto_password_tracker_frmChangeMaster
            // 
            ...
            this.Name = "howto_password_tracker_frmChangeMaster";
            this.Text = "howto_password_tracker_frmChangeMaster";
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.howto_password_tracker_frmChangeMaster_FormClosing);
            this.Load += new System.EventHandler(this.howto_password_tracker_frmChangeMaster_Load);
