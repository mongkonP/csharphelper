...
using howto_covid19_all;
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_covid19_all_Form1:Form
  {
        ...
        private void LoadPopulationData()
        {
            ...
            population_dict.Add("All", all_pop);
        ...
        public howto_covid19_all_Form1()
        {
            InitializeComponent();
        }
        ...
        private void howto_covid19_all_Form1_Load(object sender, EventArgs e)
        {
            Show();
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "howto_covid19_all_Form1";
            this.Text = "howto_covid19_all";
            this.Load += new System.EventHandler(this.howto_covid19_all_Form1_Load);
