...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class targetfolder2_Form1:Form
  { 


        public targetfolder2_Form1()
        {
            InitializeComponent();
        }

        // Add the target folders to the folder text box.
       private void targetfolder2_Form1_Load(object sender, EventArgs e)
        {
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "targetfolder2_Form1";
            this.Text = "howto_delete_files";
            this.Load += new System.EventHandler(this.targetfolder2_Form1_Load);
