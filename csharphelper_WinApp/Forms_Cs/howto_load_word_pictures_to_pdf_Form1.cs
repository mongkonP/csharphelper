...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_load_word_pictures_to_pdf_Form1:Form
  { 


        public howto_load_word_pictures_to_pdf_Form1()
        {
            InitializeComponent();
        }

        // Load the directory setting.
        private void howto_load_word_pictures_to_pdf_Form1_Load(object sender, EventArgs e)
        {
            ...
            if (txtFilename.Text.Length == 0)
                txtFilename.Text = app_path + "\\Pictures.pdf";
        }

        // Save the directory setting.
        private void howto_load_word_pictures_to_pdf_Form1_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void btnCreateFile_Click(object sender, EventArgs e)
        {
            ...
            // Save the document.
            word_doc.ExportAsFixedFormat(filename,
                ...
                false,          // UseISO19005_1
                ref missing);   // FixedFormatExtClassPtr
...
/// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(howto_load_word_pictures_to_pdf_Form1));
            ...
            this.clbFiles.Size = new System.Drawing.Size(327, 152);
            ...
            // 
            // howto_load_word_pictures_to_pdf_Form1
            // 
            ...
            this.Name = "howto_load_word_pictures_to_pdf_Form1";
            this.Text = "howto_load_word_pictures_to_pdf";
            this.Load += new System.EventHandler(this.howto_load_word_pictures_to_pdf_Form1_Load);
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.howto_load_word_pictures_to_pdf_Form1_FormClosing);
