...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_sunburst_chart_Form1:Form
  { 


        public howto_sunburst_chart_Form1()
        {
            InitializeComponent();
        }
        ...
        private void howto_sunburst_chart_Form1_Load(object sender, EventArgs e)
        {
        ...
        private void howto_sunburst_chart_Form1_Resize(object sender, EventArgs e)
        {
            MakeSunburst();
        }
            ...
            out Color bg_color, out Color fg_color)
        {
            ...
            DrawCenteredText(gr, font, fg_color, text, new PointF(text_x, text_y));
        }
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "howto_sunburst_chart_Form1";
            this.Text = "howto_sunburst_chart";
            this.Load += new System.EventHandler(this.howto_sunburst_chart_Form1_Load);
            this.Resize += new System.EventHandler(this.howto_sunburst_chart_Form1_Resize);
