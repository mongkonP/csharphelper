...
using howto_colored_trominoes;
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_colored_trominoes_Form1:Form
  { 


        public howto_colored_trominoes_Form1()
        {
            InitializeComponent();
        }
        ...
        private void howto_colored_trominoes_Form1_Load(object sender, EventArgs e)
        {
            MakeBoard();
        }
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "howto_colored_trominoes_Form1";
            this.Text = "howto_colored_trominoes";
            this.Load += new System.EventHandler(this.howto_colored_trominoes_Form1_Load);
