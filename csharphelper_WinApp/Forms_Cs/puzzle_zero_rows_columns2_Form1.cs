...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class puzzle_zero_rows_columns2_Form1:Form
  { 


        public puzzle_zero_rows_columns2_Form1()
        {
            InitializeComponent();
        }
            ...
            for (int row = 0; row <= values.GetUpperBound(0); row++)
            {
                for (int col = 0; col <= values.GetUpperBound(1); col++)
                {
                    ...
                    if (is_zero[row, col])
                    {
                        ...
                        {
                            Console.WriteLine("Skipping column " + col.ToString() + ".");
                        }
                        ...
                        {
                            Console.WriteLine("Skipping row " + row.ToString() + ".");
                        }
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            // 
            // puzzle_zero_rows_columns2_Form1
            // 
            ...
            this.Name = "puzzle_zero_rows_columns2_Form1";
            this.Text = "puzzle_zero_rows_columns2";
