...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_phoenix_set_Form1:Form
  { 


        public howto_phoenix_set_Form1()
        {
            InitializeComponent();
        }
        ...
        private void howto_phoenix_set_Form1_Load(object sender, EventArgs e)
        {
            this.Show();
            Application.DoEvents();
            ...
            ResetColors();
            howto_phoenix_set_PhoenixConfig frm = new  howto_phoenix_set_PhoenixConfig();
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "howto_phoenix_set_Form1";
            this.Text = "howto_phoenix_set";
            this.Load += new System.EventHandler(this.howto_phoenix_set_Form1_Load);
