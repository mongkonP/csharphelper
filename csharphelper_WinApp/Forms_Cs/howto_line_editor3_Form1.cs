...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_line_editor3_Form1:Form
  { 


        public howto_line_editor3_Form1()
        {
            InitializeComponent();
        }
        ...
        // Locations of the trash icon.
        private RectangleF TrashRect;
        private void howto_line_editor3_Form1_Load(object sender, EventArgs e)
        {
            const int margin = 4;
            const int icon_size = 32;

            // Position the trash icon.
            int wid = Properties.Resources.trash.Width;
            int hgt = Properties.Resources.trash.Height;
            float hscale = icon_size / (float)Properties.Resources.trash.Width;
            float vscale = icon_size / (float)Properties.Resources.trash.Height;
            float scale = Math.Min(hscale, vscale);
            float width = scale * Properties.Resources.trash.Width;
            float height  = scale * Properties.Resources.trash.Height;
            TrashRect = new RectangleF(margin, margin, width, height);
        }
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.picCanvas.Size = new System.Drawing.Size(260, 223);
            ...
            this.saveAsToolStripMenuItem.Click += new System.EventHandler(this.mnuFileSave_Click);
            // 
            ...
            this.saveAsToolStripMenuItem1.Click += new System.EventHandler(this.mnuFileSave_Click);
            // 
            // howto_line_editor3_Form1
            // 
            ...
            this.Name = "howto_line_editor3_Form1";
            this.Text = "howto_line_editor3";
            this.Load += new System.EventHandler(this.howto_line_editor3_Form1_Load);
