...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_ellipse_ellipse_intersection_Form1:Form
  { 


        public howto_ellipse_ellipse_intersection_Form1()
        {
            InitializeComponent();
        }
        ...
        private void howto_ellipse_ellipse_intersection_Form1_Load(object sender, EventArgs e)
        {
        ...
        private void FindPointsOfIntersection(float xmin, float xmax)
        {
            ...
            foreach (float sign1 in signs)
            {
                ...
                {
                    List<PointF> points = FindRootsUsingNewtonsMethod(
                        xmin, xmax,
        ...
        private List<PointF> FindRootsUsingNewtonsMethod(float xmin, float xmax,
            float A1, float B1, float C1, float D1, float E1, float F1, float sign1,
            float A2, float B2, float C2, float D2, float E2, float F2, float sign2)
        {
        ...
        private void UseNewtonsMethod(float x0, out float x, out float y,
            float A1, float B1, float C1, float D1, float E1, float F1, float sign1,
            float A2, float B2, float C2, float D2, float E2, float F2, float sign2)
        {
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            // 
            // howto_ellipse_ellipse_intersection_Form1
            // 
            this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
            this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
            this.ClientSize = new System.Drawing.Size(361, 426);
            this.Controls.Add(this.tableLayoutPanel1);
            this.Name = "howto_ellipse_ellipse_intersection_Form1";
            this.Text = "howto_ellipse_ellipse_intersection";
            this.Load += new System.EventHandler(this.howto_ellipse_ellipse_intersection_Form1_Load);
