...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_anon_methods_Form1:Form
  { 


        public howto_anon_methods_Form1()
        {
            InitializeComponent();
        }
        ...
        {
            DrawGraph(delegate(float x, float y) { return (float)(y - 3 * Math.Cos(x) / x); });
        }
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.picGraph.TabIndex = 19;
            this.picGraph.TabStop = false;
            // 
            // howto_anon_methods_Form1
            // 
            ...
            this.Name = "howto_anon_methods_Form1";
            this.Text = "howto_anon_methods";
