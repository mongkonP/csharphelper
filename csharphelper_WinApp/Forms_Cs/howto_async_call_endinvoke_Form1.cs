...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_async_call_endinvoke_Form1:Form
  { 


        public howto_async_call_endinvoke_Form1()
        {
            InitializeComponent();
        }
        ...
        private void howto_async_call_endinvoke_Form1_Load(object sender, EventArgs e)
        {
        ...
        private void btnAsync_Click(object sender, EventArgs e)
        {
            ...
            IAsyncResult result1 = caller.BeginInvoke(bm1, null, null);
            IAsyncResult result2 = caller.BeginInvoke(bm2, null, null);
            IAsyncResult result3 = caller.BeginInvoke(bm3, null, null);
            IAsyncResult result4 = caller.BeginInvoke(bm4, null, null);
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            // 
            // howto_async_call_endinvoke_Form1
            // 
            ...
            this.Name = "howto_async_call_endinvoke_Form1";
            this.Text = "howto_async_call_endinvoke";
            this.Load += new System.EventHandler(this.howto_async_call_endinvoke_Form1_Load);
