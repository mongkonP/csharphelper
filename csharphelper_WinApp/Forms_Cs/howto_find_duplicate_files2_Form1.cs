...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_find_duplicate_files2_Form1:Form
  { 


        public howto_find_duplicate_files2_Form1()
        {
            InitializeComponent();
        }

        // Save and restore the directory path.
        private void howto_find_duplicate_files2_Form1_Load(object sender, EventArgs e)
        {
        ...
        private void howto_find_duplicate_files2_Form1_FormClosing(object sender, FormClosingEventArgs e)
        {
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            // 
            // howto_find_duplicate_files2_Form1
            // 
            ...
            this.Name = "howto_find_duplicate_files2_Form1";
            this.Text = "howto_find_duplicate_files2";
            this.Load += new System.EventHandler(this.howto_find_duplicate_files2_Form1_Load);
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.howto_find_duplicate_files2_Form1_FormClosing);
