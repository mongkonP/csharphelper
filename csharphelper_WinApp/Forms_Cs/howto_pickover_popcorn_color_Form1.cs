...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_pickover_popcorn_color_Form1:Form
  { 


        public howto_pickover_popcorn_color_Form1()
        {
            InitializeComponent();
        }
        ...
        private void howto_pickover_popcorn_color_Form1_Load(object sender, EventArgs e)
        {
        ...
        private void btnPlotAll_Click(object sender, EventArgs e)
        {
            ...
            for (int x = 0; x < Bm.Width; x += dx)
            {
                ...
                {
                    PlotPoints(Bm, H, x, y, IterationsPerPixel, RgbType);
                    RgbType = ++RgbType % 3;
                }
                picCanvas.Refresh();
            }
        ...
        private void picCanvas_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            PlotPoints(Bm, H, e.X, e.Y, IterationsPerPixel, RgbType);
            RgbType = ++RgbType % 3;
            picCanvas.Refresh();
        }
        ...
        private void PlotPoints(Bitmap bm, float h, int pix_x, int pix_y, int iterations, int rgb_type)
        {
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            // 
            // howto_pickover_popcorn_color_Form1
            // 
            ...
            this.Name = "howto_pickover_popcorn_color_Form1";
            this.Text = "howto_pickover_popcorn_color";
            this.Load += new System.EventHandler(this.howto_pickover_popcorn_color_Form1_Load);
