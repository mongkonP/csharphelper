...
using howto_custom_exception;
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_custom_exception_Form1:Form
  { 


        public howto_custom_exception_Form1()
        {
            InitializeComponent();
        }
        ...
        private double ParseFileSize(string value, int kb_value)
        {
            ...
            {
                suffix_string = value.Substring(ext_start).Trim();
            }
            else
            {
                suffix_string = "bytes";
            ...
            string suffix = suffix_string.ToUpper();
            if (suffix == "BYTES") suffix = "bytes";
            int suffix_index = -1;
            for (int i = 0; i < SizeSuffixes.Length; i++)
            {
                if (SizeSuffixes[i] == suffix_string)
                {
                    suffix_index = i;
                    break;
                }
            ...
            if (suffix_index < 0)
                throw new UnknownExtensionException(suffix_string,
                    "Unknown file size extension " + suffix_string + ".");
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.txtCheck.Size = new System.Drawing.Size(162, 20);
            ...
            this.txtBytes.Size = new System.Drawing.Size(162, 20);
            ...
            this.btnParse.Location = new System.Drawing.Point(227, 12);
            ...
            this.Name = "howto_custom_exception_Form1";
            this.Text = "howto_custom_exception";
