...
using howto_apollonius_problem;
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_apollonius_problem_Form1:Form
  { 


        public howto_apollonius_problem_Form1()
        {
            InitializeComponent();
        }

        // The given circles.
        private Circle[] GivenCircles =
        {
            new Circle(120, 110, 50),
            new Circle(160, 250, 70),
            new Circle(280, 130, 60),
        };
        ...
        private void howto_apollonius_problem_Form1_Load(object sender, EventArgs e)
        {
            CheckBoxes = new CheckBox[] { chk1, chk2, chk3, chk4, chk5, chk6, chk7, chk8 };
            DoubleBuffered = true;

            SolutionCircles = FindApollonianCircles(GivenCircles);
        }

        // Draw the circles.
        private void howto_apollonius_problem_Form1_Paint(object sender, PaintEventArgs e)
        {
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "howto_apollonius_problem_Form1";
            this.Text = "howto_apollonius_problem";
            this.Load += new System.EventHandler(this.howto_apollonius_problem_Form1_Load);
            this.Paint += new System.Windows.Forms.PaintEventHandler(this.howto_apollonius_problem_Form1_Paint);
