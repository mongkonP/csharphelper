...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_plinq_evens_Form1:Form
  { 


        public howto_plinq_evens_Form1()
        {
            InitializeComponent();
        }

        // Generate a list of numbers and pick out the even ones.
        private void btnGo_Click(object sender, EventArgs e)
        {
            ...
            // Use LINQ to find the even numbers.
            watch.Restart();
            var linq_query =
                from int number in numbers
                where number % 2 == 0
                select number;
            int[] linq_evens = linq_query.ToArray();
            watch.Stop();
            lstLinq.DataSource = linq_evens.Take(1000).ToArray();
            lblLinq.Text = watch.Elapsed.TotalSeconds.ToString("0.00") + " secs";
            lblLinq.Refresh();
            lstLinq.Refresh();

            // Use PLINQ to find the even numbers.
            watch.Restart();
            var plinq_query =
                from int number in numbers.AsParallel()
                where number % 2 == 0
                select number;
            int[] plinq_evens = plinq_query.ToArray();
            watch.Stop();
            lstPlinq.DataSource = plinq_evens.Take(1000).ToArray();
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.lstAllNumbers.TabIndex = 17;
            // 
            // label2
            // 
            ...
            this.txtNumNumbers.TabIndex = 14;
            ...
            this.Name = "howto_plinq_evens_Form1";
            this.Text = "howto_plinq_evens";
