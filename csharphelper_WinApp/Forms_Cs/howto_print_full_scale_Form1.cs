...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_print_full_scale_Form1:Form
  { 


        public howto_print_full_scale_Form1()
        {
            InitializeComponent();
        }
        ...
        private void DrawLines(Graphics gr)
        {
            ...
            if (IsDrawing)
            {
                gr.DrawLine(Pens.Red, NewPt1, NewPt2);
            }
        }
...
/// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(howto_print_full_scale_Form1));
            this.picCanvas = new System.Windows.Forms.PictureBox();
            this.menuStrip1 = new System.Windows.Forms.MenuStrip();
            this.fileToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            this.mnuFilePrint = new System.Windows.Forms.ToolStripMenuItem();
            this.mnuFilePrintPreview = new System.Windows.Forms.ToolStripMenuItem();
            this.pdocLines = new System.Drawing.Printing.PrintDocument();
            this.pdlgLines = new System.Windows.Forms.PrintPreviewDialog();
            ...
            // pdocLines
            // 
            this.pdocLines.DocumentName = "Lines";
            this.pdocLines.PrintPage += new System.Drawing.Printing.PrintPageEventHandler(this.pdocLines_PrintPage);
            // 
            // pdlgLines
            // 
            this.pdlgLines.AutoScrollMargin = new System.Drawing.Size(0, 0);
            this.pdlgLines.AutoScrollMinSize = new System.Drawing.Size(0, 0);
            this.pdlgLines.ClientSize = new System.Drawing.Size(400, 300);
            this.pdlgLines.Document = this.pdocLines;
            this.pdlgLines.Enabled = true;
            this.pdlgLines.Icon = ((System.Drawing.Icon)(resources.GetObject("pdlgLines.Icon")));
            this.pdlgLines.Name = "pdlgLines";
            this.pdlgLines.Visible = false;
            // 
            // howto_print_full_scale_Form1
            // 
            ...
            this.Name = "howto_print_full_scale_Form1";
        ...
        private System.Drawing.Printing.PrintDocument pdocLines;
        private System.Windows.Forms.PrintPreviewDialog pdlgLines;
    }
}
