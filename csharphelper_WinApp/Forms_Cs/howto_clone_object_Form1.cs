...
using howto_clone_object;
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_clone_object_Form1:Form
  { 


        public howto_clone_object_Form1()
        {
            InitializeComponent();
        }

        private Person person1, person2, person3;
        private void howto_clone_object_Form1_Load(object sender, EventArgs e)
        {
            // Make a Person.
            person1 = new Person()
            {
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.propDeepClone.TabIndex = 10;
            ...
            this.propShallowClone.TabIndex = 8;
            ...
            this.Name = "howto_clone_object_Form1";
            this.Text = "howto_clone_object";
            this.Load += new System.EventHandler(this.howto_clone_object_Form1_Load);
