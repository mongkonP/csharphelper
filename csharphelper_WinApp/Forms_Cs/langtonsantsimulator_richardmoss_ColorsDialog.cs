...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class langtonsantsimulator_richardmoss_ColorsDialog:langtonsantsimulator_richardmoss_BaseForm
  { 


  #region  Public Constructors  

    public langtonsantsimulator_richardmoss_ColorsDialog()
    {
      InitializeComponent();
    }

    public langtonsantsimulator_richardmoss_ColorsDialog(ColorParameters parameters)
      : this()
    {
...
/// <summary>
    ...
    private void InitializeComponent()
    {
      ...
      // 
      // langtonsantsimulator_richardmoss_ColorsDialog
      // 
      ...
      this.Name = "langtonsantsimulator_richardmoss_ColorsDialog";
