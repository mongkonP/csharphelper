...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_draw_graph_Form1:Form
  { 


        public howto_draw_graph_Form1()
        {
            InitializeComponent();
        }
