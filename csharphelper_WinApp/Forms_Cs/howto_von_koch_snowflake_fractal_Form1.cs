...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_von_koch_snowflake_fractal_Form1:Form
  { 


        public howto_von_koch_snowflake_fractal_Form1()
        {
            InitializeComponent();
        }
        ...
        private void btnGo_Click(object sender, EventArgs e)
        {
            ...
            float height = Math.Min(
                ...
                picCanvas.ClientSize.Height) - 100;
            float x1 = (picCanvas.ClientSize.Width - height) / 2;
            float x2 = x1 + height;
            float y1 = (picCanvas.ClientSize.Height - height) / 2;
            float y2 = y1 + height;
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            // 
            // howto_von_koch_snowflake_fractal_Form1
            // 
            ...
            this.Name = "howto_von_koch_snowflake_fractal_Form1";
            this.Text = "howto_von_koch_snowflake_fractal";
