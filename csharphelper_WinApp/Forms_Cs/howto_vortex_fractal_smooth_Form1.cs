...
namespace csharphelper_WinApp.Forms_Cs
{
    ...
    public partial class howto_vortex_fractal_smooth_Form1 : Form
    {
        public howto_vortex_fractal_smooth_Form1()
        {
            InitializeComponent();
        }
        ...
        private void DrawVortex()
        {
            ...
            for (int X = 0; X < wid; X++)
            {
                ...
                for (int Y = 0; Y < hgt; Y++)
                {
                    Complex ZN = new Complex(Zrea, Zima);
                    Complex ZNminus1 = new Complex(Zrea, Zima);
                    int iteration = 1;
                    while ((iteration < MaxIterations) && (ZN.MagnitudeSquared < escape_squared))
                    {
                        // Calculate Z(clr).
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            double mu = iteration + 1 -
                                Math.Log(Math.Log(ZN.Magnitude)) / log_escape;
        ...
        private void howto_vortex_fractal_smooth_Form1_Load(object sender, EventArgs e)
        {
            this.Show();
            Application.DoEvents();
            ...
            ResetColors();
            howto_vortex_fractal_smooth_VortexConfig frm = new howto_vortex_fractal_smooth_VortexConfig();
            frm.Initialize(this);
            frm.SetDefaultColors();
            frm.AcceptSelections();
            frm.Close();

            // Display the first Vortex set.
            mnuScaleFull_Click(null, null);
        }
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            // 
            // howto_vortex_fractal_smooth_Form1
            // 
            ...
            this.Name = "howto_vortex_fractal_smooth_Form1";
            this.Text = "howto_vortex_fractal";
            this.Load += new System.EventHandler(this.howto_vortex_fractal_smooth_Form1_Load);
