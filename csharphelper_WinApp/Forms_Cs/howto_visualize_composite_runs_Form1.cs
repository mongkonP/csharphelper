...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_visualize_composite_runs_Form1:Form
  { 


        public howto_visualize_composite_runs_Form1()
        {
            InitializeComponent();
        }
        ...
        private Bitmap MakeBitmap(bool[] is_prime, int wid, int hgt)
        {
            ...
            // Get ready to calculate colors.
            float dc = 255f / (max_run_length - 1);
            ...
            for (int y = 0; y < hgt; y++)
            {
                for (int x = 0; x < wid; x++)
                {
                    ...
                    {
                        byte c = (byte)(run_length * dc);
                        bm.SetPixel(x, y, Color.FromArgb(c, c, c));
                    }

                    if (is_prime[index]) run_length = 0;
                    else run_length++;
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            // 
            // howto_visualize_composite_runs_Form1
            // 
            ...
            this.Name = "howto_visualize_composite_runs_Form1";
            this.Text = "howto_visualize_composite_runs";
