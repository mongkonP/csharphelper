...
using howto_use_property_grid;
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_use_property_grid_Form1:Form
  { 


        public howto_use_property_grid_Form1()
        {
            InitializeComponent();
        }

        private void howto_use_property_grid_Form1_Load(object sender, EventArgs e)
        {
            // Make some people.
            Person[] people =
            {
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "howto_use_property_grid_Form1";
            this.Text = "howto_use_property_grid";
            this.Load += new System.EventHandler(this.howto_use_property_grid_Form1_Load);
