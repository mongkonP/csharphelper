...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_mandelbrot_Form1:Form
  { 


        public howto_mandelbrot_Form1()
        {
            InitializeComponent();
        }
        ...
        private void howto_mandelbrot_Form1_Load(object sender, EventArgs e)
        {
            this.Show();
            Application.DoEvents();
            ...
            ResetColors();
            howto_mandelbrot_MandelbrotConfig frm = new  howto_mandelbrot_MandelbrotConfig();
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "howto_mandelbrot_Form1";
            this.Text = "howto_mandelbrot";
            this.Load += new System.EventHandler(this.howto_mandelbrot_Form1_Load);
