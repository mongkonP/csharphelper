...
using howto_protected_access;
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_protected_access_Form1:Form
  { 


        public howto_protected_access_Form1()
        {
            InitializeComponent();
        }

        // Get the password from the user.
        private void howto_protected_access_Form1_Load(object sender, EventArgs e)
        {
            // Get the password from the user.
            howto_protected_access_PasswordForm frm = new  howto_protected_access_PasswordForm();
        ...
        // Load the data from the database connection.
        private void LoadData(OleDbConnection conn)
        {
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(howto_protected_access_Form1));
            ...
            this.Name = "howto_protected_access_Form1";
            this.Text = "howto_protected_access";
            this.Load += new System.EventHandler(this.howto_protected_access_Form1_Load);
