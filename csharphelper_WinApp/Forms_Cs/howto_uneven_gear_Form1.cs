...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_uneven_gear_Form1:Form
  { 


        public howto_uneven_gear_Form1()
        {
            InitializeComponent();
        }

        // Reduce flicker.
        private void howto_uneven_gear_Form1_Load(object sender, EventArgs e)
        {
            DoubleBuffered = true;
        }

        // The angle used as the gears' origins in degrees.
        ...
        private void picGears_Resize(object sender, EventArgs e)
        {
            picGears.Refresh();
        }
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.picGears.Size = new System.Drawing.Size(333, 302);
            this.picGears.TabIndex = 1;
            this.picGears.TabStop = false;
            this.picGears.Resize += new System.EventHandler(this.picGears_Resize);
            this.picGears.Paint += new System.Windows.Forms.PaintEventHandler(this.picGears_Paint);
            // 
            // howto_uneven_gear_Form1
            // 
            ...
            this.Name = "howto_uneven_gear_Form1";
            this.Text = "howto_animate_gear";
            this.Load += new System.EventHandler(this.howto_uneven_gear_Form1_Load);
