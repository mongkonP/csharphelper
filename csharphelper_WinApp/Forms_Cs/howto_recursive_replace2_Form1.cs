...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_recursive_replace2_Form1:Form
  { 


        public howto_recursive_replace2_Form1()
        {
            InitializeComponent();
        }

        // Restore previous settings.
        private void howto_recursive_replace2_Form1_Load(object sender, EventArgs e)
        {
        ...
        private void howto_recursive_replace2_Form1_FormClosing(object sender, FormClosingEventArgs e)
        {
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            // 
            // howto_recursive_replace2_Form1
            // 
            ...
            this.Name = "howto_recursive_replace2_Form1";
            this.Text = "howto_recursive_replace";
            this.Load += new System.EventHandler(this.howto_recursive_replace2_Form1_Load);
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.howto_recursive_replace2_Form1_FormClosing);
