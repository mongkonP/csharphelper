...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class langtonsantsimulator_richardmoss_SimulationPanel:Panel
  { 
  ...
  #region  Public Constructors  
    ...
    public langtonsantsimulator_richardmoss_SimulationPanel()
      : this(null)
    { }

    public langtonsantsimulator_richardmoss_SimulationPanel(IContainer container)
    {
