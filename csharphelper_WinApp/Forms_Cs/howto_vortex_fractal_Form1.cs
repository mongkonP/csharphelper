...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_vortex_fractal_Form1:Form
  { 


        public howto_vortex_fractal_Form1()
        {
            InitializeComponent();
        }
        ...
        private void howto_vortex_fractal_Form1_Load(object sender, EventArgs e)
        {
            this.Show();
            Application.DoEvents();
            ...
            ResetColors();
            howto_vortex_fractal_VortexConfig frm = new howto_vortex_fractal_VortexConfig();
...
/// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "howto_vortex_fractal_Form1";
            this.Text = "howto_vortex_fractal";
            this.Load += new System.EventHandler(this.howto_vortex_fractal_Form1_Load);
