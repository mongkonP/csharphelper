...
namespace csharphelper_WinApp.Forms_Cs 
    {
     public partial class howto_split_text_Form1:Form
  { 


        public howto_split_text_Form1()
        {
            InitializeComponent();
        }
