...
public class Block
    {
        ...
        // Draw the block.
        public virtual void Draw(Graphics gr, Brush fg_brush, Brush bg_brush, Pen pen)
        {
...
// http://csharphelper.com/blog/2014/08/get-font-metrics-in-c/
    ...
    public class PictureBlock : Block
    {
        ...
        // Draw the block.
        public override void Draw(Graphics gr, Brush fg_brush, Brush bg_brush, Pen pen)
        {
            if (Bounds.X < 0) return;
