...
using System.Drawing.Drawing2D;
  ...
  namespace  howto_listview_print_large_data
...
public static class ExtensionProperties
    ...
    public static class ListViewExtensions
    {
        ...
        public static void PrintMultiLineData(this ListView lvw, Point location, Graphics gr,
            Brush header_brush, Brush data_brush, Pen grid_pen)
        {
            const int x_margin = 5;
            const int y_margin = 3;
        ...
        private static void DrawMultiLineItems(string[] items, Graphics gr, Font lvw_font,
            Brush header_brush, Pen grid_pen, float x_margin, float y_margin,
