...
{
    /// <summary>
    /// Interaction logic for howto_WPF_3D_arrows_Window1.xaml
    /// </summary>
    public partial class howto_WPF_3D_arrows_Window1 : Window
    {
        public howto_WPF_3D_arrows_Window1()
        {
            InitializeComponent();
        }
        ...
        private void chkContents_Click(object sender, RoutedEventArgs e)
        {
            ...
            if ((XArrowModel != null) && ((bool)chkArrows.IsChecked))
            {
