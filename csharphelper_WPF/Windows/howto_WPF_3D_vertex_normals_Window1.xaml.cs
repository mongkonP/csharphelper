...
{
    /// <summary>
    /// Interaction logic for howto_WPF_3D_vertex_normals_Window1.xaml
    /// </summary>
    public partial class howto_WPF_3D_vertex_normals_Window1 : Window
    {
        public howto_WPF_3D_vertex_normals_Window1()
        {
            InitializeComponent();
        }
        ...
        private void DefineModel(Model3DGroup model_group)
        {
...
#if false //@
            for (double x = 0; x <= 2 * dx; x += dx)
            {
                for (double z = 0; z <= 2 * dz; z += dx)
                {
            ...
            //AddTriangle(mesh,
            //    new Point3D(xmin, -7, zmin),
            //    new Point3D(xmin, -7, zmax),
            //    new Point3D(0, 0, 0));
            //AddTriangle(mesh,
            //    new Point3D(xmax, 5, zmax),
            //    new Point3D(xmax, 5, 0),
            //    new Point3D(0, 0, 0));
            //AddTriangle(mesh,
            //    new Point3D(xmax, 5, 0),
            //    new Point3D(xmax, 5, zmin),
            //    new Point3D(0, 0, 0));
#else //@
            ...
            // Make the normals.
            MeshGeometry3D normals = mesh.ToTriangleNormals(length, thickness);
