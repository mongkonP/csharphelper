...
{
    /// <summary>
    /// Interaction logic for howto_WPF_3D_wireframe_Window1.xaml
    /// </summary>
    public partial class howto_WPF_3D_wireframe_Window1 : Window
    {
        public howto_WPF_3D_wireframe_Window1()
        {
            InitializeComponent();
        }
        ...
        private void DefineModel(Model3DGroup model_group)
        {
            ...
            // Make a wireframe.
#if SURFACE2
            MeshGeometry3D wireframe = mesh.ToWireframe(0.01);
#else
